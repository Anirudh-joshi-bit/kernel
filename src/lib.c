...
/*
 * hardfault and nmi handlers are implemented in asm as the stack might be
 * corrupted using c for handling these faults can access the stack and lead the
 * kernel into lock up state
 *
 */
